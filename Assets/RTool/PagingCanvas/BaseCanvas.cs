...
namespace RTool.PagingCanvas
{
    ...
    public class BaseCanvas : MonoBehaviour
    {
        ...
        public Action<BaseCanvas> onShowFinished;
        public Action<BaseCanvas> onHideFinished;
        ...
        {
            //SearchForCanvasGroup();
        }
        //internal void SearchForCanvasGroup()
        //{
        //    if (canvasGroup == null)
        //    {
        ...
        #region editor
#if UNITY_EDITOR
        //protected static List<int> idList = new List<int>();
        ...
        protected virtual void OnValidate()
        {
            ...
            {
                //Debug.Log("Add: " + GetInstanceID().ToString(), gameObject);
                EditorAwake();
        ...
        {
            //Debug.Log("Remove: " + GetInstanceID().ToString());
        ...
        const string hideFlagName = "RTool / PagingCanvas / Hide all BaseCanvas";
        ...
        const string previewFlagName = "RTool / PagingCanvas / Reset all PreviewFlag";
